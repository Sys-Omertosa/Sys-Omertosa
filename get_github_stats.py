...
if __name__ == '__main__':
    """
    Modified from Andrew Grant (Andrew6rant)'s repository
    """
    ...
    # TODO: Replace the date below with your actual birthday (year, month, day)
    age_data, age_time = perf_counter(daily_readme, datetime.datetime(2004, 10, 26))
